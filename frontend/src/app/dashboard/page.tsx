      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              href="/warmup"
              className="group bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-orange-500/50 hover:bg-orange-500/5 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-orange-500/20 rounded-xl flex items-center justify-center group-hover:bg-orange-500/30 transition-colors">
            ...
            <Link
              ...
              className="group bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-blue-500/20 rounded-xl flex items-center justify-center group-hover:bg-blue-500/30 transition-colors">
            ...
            <Link
              href="/meals"
              className="group bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-green-500/50 hover:bg-green-500/5 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-green-500/20 rounded-xl flex items-center justify-center group-hover:bg-green-500/30 transition-colors">
            ...
            <Link
              href="/submit"
              className="group bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-purple-500/50 hover:bg-purple-500/5 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-purple-500/20 rounded-xl flex items-center justify-center group-hover:bg-purple-500/30 transition-colors">
            ...
            <Link
              href="/leaderboard"
              className="group bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-yellow-500/50 hover:bg-yellow-500/5 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-yellow-500/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-500/30 transition-colors">
            ...
            <Link
              href="/referrals"
              className="group bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-pink-500/50 hover:bg-pink-500/5 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-pink-500/20 rounded-xl flex items-center justify-center group-hover:bg-pink-500/30 transition-colors">
            ...
            <Link
              ...
              className="group bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-xl p-6 hover:border-yellow-500/60 hover:from-yellow-500/20 hover:to-orange-500/20 transition-all duration-300 ios-card-press"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 flex-shrink-0 bg-yellow-500/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-500/30 transition-colors">
                  <svg className="w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
