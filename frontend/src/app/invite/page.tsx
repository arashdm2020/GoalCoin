  ...
  return (
    <div className="min-h-screen bg-black text-[#FFD700] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        <h1 className="text-4xl font-bold mb-2 text-glow">Invite & Earn</h1>
        ...
        <div className="bg-gray-900 rounded-lg border border-[#FFD700]/20 p-8">
          <p className="text-gray-300">
            Our referral program is under construction. Get ready to earn rewards for inviting your friends to GoalCoin.
          </p>
        </div>
